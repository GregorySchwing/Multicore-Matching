...
class GraphMatching
{
	public:
		...
		virtual void performMatching(std::vector<int> &, cudaEvent_t &, cudaEvent_t &, std::vector<int> & fll, std::vector<int> & bll, std::vector<int> & lengthOfPath, std::vector<int> & degree, std::vector<int> & edgestatus) const = 0;
...
class GraphMatchingCPURandom : public GraphMatching
{
	public:
		...
		void performMatching(std::vector<int> &, cudaEvent_t &, cudaEvent_t &, std::vector<int> & fll, std::vector<int> & bll, std::vector<int> & lengthOfPath, std::vector<int> & degree, std::vector<int> & edgestatus) const;
};
