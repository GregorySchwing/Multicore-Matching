...
class GraphMatchingGPU : public GraphMatching
{
	public:
		...
		virtual void performMatching(int *, cudaEvent_t &, cudaEvent_t &, int * dforwardlinkedlist, int * dbackwardlinkedlist, int * dlength, const int * ddegree) const = 0;
...
class GraphMatchingGPURandom : public GraphMatchingGPU
{
	public:
		...
		void performMatching(int *, cudaEvent_t &, cudaEvent_t &, int * dforwardlinkedlist, int * dbackwardlinkedlist, int * dlength, const int * ddegree) const;
