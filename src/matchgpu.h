...
class GraphMatchingGPU : public GraphMatching
{
	public:
		...
		virtual void performMatching(std::vector<int> &, cudaEvent_t &, cudaEvent_t &, std::vector<int> & fll, std::vector<int> & bll, int * dlength, const int * ddegree, const int * dedgestatus) const = 0;
	protected:
...
class GraphMatchingGPURandom : public GraphMatchingGPU
{
	public:
		...
		void performMatching(std::vector<int> &, cudaEvent_t &, cudaEvent_t &, std::vector<int> & fll, std::vector<int> & bll, int * dlength, const int * ddegree, const int * dedgestatus) const;
