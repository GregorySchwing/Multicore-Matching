...
void GraphMatchingCPURandom::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
...
void GraphMatchingCPUMinDeg::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
 numberOfDynamicallyAddedVertices, int leafIndex) const
{
...
void GraphMatchingCPUStatMinDeg::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
 numberOfDynamicallyAddedVertices, int leafIndex) const
{
...
void GraphMatchingCPUKarpSipser::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
 numberOfDynamicallyAddedVertices, int leafIndex) const
{
...
void GraphMatchingCPUWeighted::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
 numberOfDynamicallyAddedVertices, int leafIndex) const
{
...
void GraphMatchingCPUWeightedEdge::performMatching(int *match, cudaEvent_t &t1, cudaEvent_t &t2, int * dforwardlinkedlist,  int * dbackwardlinkedlist, int * dlength, int2 * dsearchtree, int * dynamicallyAddedVertices, int 
 numberOfDynamicallyAddedVertices, int leafIndex) const
{
	//This is a greedy weighted matching algorithm.
